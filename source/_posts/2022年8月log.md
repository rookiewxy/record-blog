 ...
 #### 八、8/11
   ...
   3. 使用vite出现的问题
      ...
      - 在使用`xt-earth`中采用了commonJS和ESmodel的混合写法，由于第一次打包部署，报require为undefined的错误，因为没有vite中不能使用commonJS的语法，查看官网，发现需要配置，optimizeDeps，
        ...
        ![image-20220811162313270](C:\Users\xt09\Desktop\blog\2022年8月log.assets\image-20220811162313270.png)
      ...
      ![image-20220811162552156](C:\Users\xt09\Desktop\blog\2022年8月log.assets\image-20220811162552156.png)
